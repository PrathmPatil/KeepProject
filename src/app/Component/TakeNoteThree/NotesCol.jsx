...
function NotesCol({ info, updatecolor }) {
    ...
    return (
        <div className='h-22 flex flex-col'>
            {info.map((notes) =>
                <Box className='mb-3 min-h-22  xs:ml-[0vw] xs:w-[98%] max:sm:ml-[0] max:sm:w-[98%] sm:ml-[0vw] sm:w-[90%] md:ml-[2vw] md:w-[88%] lg:ml-[7vw] lg:w-[70%]  xl:w-[54%] xl:ml-[13vw] xl 2xl   rounded-lg border-1 border-slate-400' sx={{ boxShadow: "1px 1px 5px 1px rgb(180, 176, 176)" }} >
