...
function NotesRow({ info, updatecolor }) {
    ...
    return (
        ...
        <div className='w-[80vw] gap-4 grid grid-cols-1 sm:grid-cols-4 grid-flow-row-dense'>
            {info.map((notes) => (
                <div key={notes.id} className='h-auto rounded-lg border-1 border-slate-400 shadow-lg '>
