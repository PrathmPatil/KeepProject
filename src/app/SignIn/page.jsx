            ...
            <div className='flex flex-col '>
                    ...
                    <div className="mt-3 sm:mx-auto sm:w-full sm:max-w-sm mb-5">
                        <form className="space-y-6" action="#" method="POST">
                            <div>
                                ...
                                <div className="flex  justify-start flex-col sm:flex-rol md:flex-row xl:flex-row 2xl:flex-row
                            ...
                            <div>
                                <div className="mt-2 xs:w-[100%]  max:sm:w-[100%] xl:w-[100%] rounded-md  py-1.5 text-gray-900   ">
                                    <TextField
                                        id="outlined-basic"
                                        fullWidth className=" rounded-md  py-1.5 text-gray-900  placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                        label="Password"
                                        variant="outlined"
                                        type="password"
                                        size='small'
                                    ...
                                    />
                                    <div onClick={() => setShow(!show)}> {show ? <VisibilityOffIcon /> : <VisibilityIcon />}</div>
                ...
                <div className='mt-2  w-full flex  justify-between'>
                    <p className=" w-1/3 text-start text-md text-gray-600 ">
                        <a href="#" className="text-xs leading-6 text-slate-900 hover:text-slate-600">
                            English(United States)
                        </a>
                        <list className="text-slate-900 "><ArrowDropDownIcon /></list>
                    </p>
                    ...
                    <div className=' w-2/4 flex flex-col md:justify-between sm:justify-between xl:justify-between 2xl:justify-between sm:flex-row md:flex-row xl:flex-row 2xl:flex-row'>
                        <p className=" text-center text-sm text-gray-500">
                            <a href="#" className=" text-xs leading-6 text-slate-600 hover:text-slate-900">
                                Help
                            </a>
                        </p>
                        <p className="text-center text-sm text-gray-500">
